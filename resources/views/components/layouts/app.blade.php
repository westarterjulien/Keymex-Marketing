                ...
                <nav class="flex-1 px-3 py-2 space-y-0.5 overflow-y-auto">
                    ...
                    <div class="pt-2 mt-1 border-t border-white/20">
                        ...
                        <a href="{{ route('settings.orders') }}"
                           class="{{ request()->routeIs('settings.orders') ? 'bg-white/20 shadow-lg' : 'hover:bg-white/10' }} flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-white font-medium transition-all duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('settings.sso') }}"
                           class="{{ request()->routeIs('settings.sso') ? 'bg-white/20 shadow-lg' : 'hover:bg-white/10' }} flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-white font-medium transition-all duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
