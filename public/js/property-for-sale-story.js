// Property For Sale Story Generator - JavaScript
var currentPropertyId = null;
var currentPhotos = [];

function openPhotoSelector(propertyId, reference, photos) {
...
function selectPhotoAndGenerate(photoIndex) {
    closePhotoSelector();
    generateStory(currentPropertyId, 'nouveau-mandat', photoIndex);
}
